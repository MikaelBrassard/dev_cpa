...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__temperature__ = __webpack_require__(716);
...
var TemperaturePage = /** @class */ (function () {
    ...
    TemperaturePage.prototype.onSelectEntrepotChange = function (selectionEntrepotChanged) {
        this.selectionEntrepot = selectionEntrepotChanged;
        console.log('Selected', selectionEntrepotChanged);
        console.log(this.Capteurs);
    };
    TemperaturePage.prototype.onSelectSectionChange = function (selectionSectionChanged) {
